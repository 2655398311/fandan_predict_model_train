...
def cal_acc(y_predict, y_test):
    ...
    print(["真实值",'预测值'],[y_test_raw,y_predict])
...
data_name = ['avg_view_num', 'avg_vistor_num', 'avg_add_cart_num', 'avg_order_buyers_num',
             ...
             'avg_vistor_avg_value', 'avg_payment_goods_num_n7']
datum = pd.read_csv('train_datav22.csv', encoding = 'gb2312')
all_data = datum[data_name]
# all_data = datum[data_name].iloc[:80000]
y_name = 'avg_payment_goods_num_n7'
x_name = data_name[:-1]
...
joblib.dump(bdt6, 'bdt6_7_avg.pkl')
...
predict_tuple_list = [
	([13603.29	, 6225,	483.2857, 88.57143, 123.7143, 80.14286,
   101.8571, 11.23143, 0.319286, 0.864314, 0.010857, 118, 119.87, 1.24],
    139),
]
...
# print(engine1)
pd.io.sql.to_sql(mean_std, 'f_mean_std_7_avg', engine1, schema='dm_event', if_exists='append')
