...
data_name = ['avg_view_num','avg_vistor_num','avg_add_cart_num','avg_order_buyers_num',
             ...
             'avg_order_goods_num','avg_per_ticket_sales','avg_vistor_avg_value','sum_payment_goods_num_n3']
datum = pd.read_csv('train_datav5.csv',encoding='gb2312')
all_data = datum[data_name]
y_name = 'sum_payment_goods_num_n3'
x_name = data_name[:-1]
...
joblib.dump(bdt6, 'bdt6_sum_3.pkl')
...
# print(engine1)
pd.io.sql.to_sql(mean_std, 'f_mean_std_3_sum', engine1, schema='dm_event', if_exists='append')